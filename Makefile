...
app.js: elm.json build/elm.js src/customElements.js src/feeds.js src/init.js src/notice.js
	...
	&& $(UGLIFYJS) src/feeds.js src/init.js --compress --mangle --toplevel --output build/init.min.js \
	...
	|| cat src/notice.js build/elm.js src/customElements.js src/feeds.js src/init.js > app.js
