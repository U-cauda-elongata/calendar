...
preset : Dict String Metadata
preset =
    Dict.fromList
        [ ( "UCEOugXOAfa-HRmRjKbH8z3Q"
          , Metadata "けものフレンズプロジェクト公式"
        ...
        , ( "UCEcMIuGR8WO2TwL9XIpjKtw"
          , Metadata "ケープペンギン / African Penguin"
        ...
        , ( "UCmYO-WfY7Tasry4D1YB4LJw"
          , Metadata "フンボルトペンギン / Humboldt Penguin"
